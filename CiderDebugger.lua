...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/petedwye/Library/Application Support/luaglider2/dev";local SOCKET_PORT=33165;local GLIDER_MAIN_FOLDER= "/Users/petedwye/NetBeansProjects/MegAndMogDemo";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
